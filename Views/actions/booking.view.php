...
<div class="p-4 mt-4 bg-light text-center text-lg-start">
    <h1 class>Réservation</h1>

    <form action="<?=URL?>actions/booking/booked" method="post">
        <input class="form-control form-control-md w-50 bg-dark mx-auto ms-lg-0" type="date" name="date" value="<?= date('Y-m-d') ?>">
                ...
                <input class="d-block form-control form-control-sm w-25 mx-auto ms-lg-0" type="number" name="guests" id="guests" min="1" max="4" value="1" placeholder="number of guests" required>
